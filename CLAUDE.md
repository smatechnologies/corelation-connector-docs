# Corelation Connector Documentation — Claude Code Project

This repository contains the Corelation Connector product documentation site built with Docusaurus.
...
| User asks "should I" or "how do I" about standards | Consult | Answer from the standards without displaying output |
